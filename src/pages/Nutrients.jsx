        ...
        nutrientsArray.map((nutrient,index) => {
          ...
          return (
            <div className='py-4' key = {index}>
              <div className="grid grid-cols-4 justify-items-center mb-2">
                <p className='justify-self-start'> {nutrient.name || recommendedNutrientsIntakeArray[index][0].slice(0, 1).toUpperCase() + recommendedNutrientsIntakeArray[index][0].slice(1) } </p>
                <p> {nutrient?.total} </p>
