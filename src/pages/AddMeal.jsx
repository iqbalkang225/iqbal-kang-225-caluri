      ...
      <div className = 'bg-white rounded-md  text-black overflow-hidden'>
        ...
        <div className = 'divide-y-2 p-2'>
          ...
          <form className = 'divide-y-2'>
            ...
            <div className = 'flex justify-between py-3'>
              ...
              <select 
                ...
                name="meal-type" className = 'text-red-500 outline-none cursor-pointer'>
          ...
          <div className = 'flex justify-between items-center p-4'>
            ...
            <p className="text-xs text-yellow-500">{percentCarbs.toFixed()}%</p>
              <p className = 'text-sm'>{ macroTotal(carbs) }</p>
