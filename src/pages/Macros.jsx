...
const Macros = () => {
  ...
  const macroPercentage = mainNutrients.map(nutrient => {
    const nutrientTotal = mainNutrients.reduce((total, nutrient) => 
      (nutrient[0].amount * nutrient[0].numOfServings) + total, 0)

      return Math.floor(((nutrient[0].amount * nutrient[0].numOfServings / nutrientTotal) * 100))
  })

  console.log(macroPercentage)
          ...
          mainNutrients.map((nutrient, index) => {
            ...
            return  <div className='grid grid-cols-5'>
                      ...
                      <div className='flex col-span-3 gap-2'>
                        ...
                        <p>{nutrient[0].name} ({nutrient[0].amount * nutrient[0].numOfServings}g)</p>
                      </div>
                      <p>{macroPercentage[index]}%</p>
