        ...
        <form className = 'relative w-full overflow-hidden font-poppins '>

            {
                ...
                ? <motion.p 
                    initial = {{y: -200}}
                    animate = {{y: 0}}
                    className = 'text-2xl font-light'> You are 1 step closer in acheving your goals! </motion.p>
                    ...
                    <motion.div 
                        ...
                        <div className = 'flex flex-col items-start space-y-6'>
                            <div className = 'space-x-2'>
                                <input
                                    className = 'appearance-none border h-5 w-5 rounded-full cursor-pointer checked:bg-white'
                                    type = 'radio'
                                    name = 'gender'
                                    value = 'male'
                                    ref = {maleRef}
...

                {
                    ...
                    ? <Link to = '/dashboard' 
                        ...
                        className = 'bg-white rounded-lg text-center py-2 px-5 w-full text-black hover:bg-red-500 hover:text-white'>
                            <motion.button
                                initial = {{y: 100}}
                                animate = {{y : 0}}>Calculate</motion.button>
                      </Link>
                    ...
                    : <>
                        <button 
                            onClick = {prevSlide}
                            type = 'button'
                            className = 'bg-white rounded-lg py-2 px-5 w-full text-black hover:bg-red-500 hover:text-white'>Previous</button>
                        
                        <button
                            onClick = {nextSlide}
                            type = 'button'
                            className = 'bg-white rounded-lg py-2 px-5 w-full text-black hover:bg-red-500 hover:text-white'>Next</button>
                        </>
