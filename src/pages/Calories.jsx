...
const Calories = () => {
  ...
  return (
    <motion.div 
            ...
            return (
              <div className="flex gap-2" key = {index}>
                ...
                <div>
                  ...
                  <p className='text-gray-500'>{percentage.toFixed()}% ({meal[1]} cal)</p>
                </div>
              </div>
      ...
      {/* calorie rows */}
      <div className="flex justify-between py-3 mt-6 border-t-2 text-sm">
        <p>Total Calories</p>
        <p> {totalCalories} </p>
      </div>

      {/* calorie rows */}
      <div className="flex justify-between py-3 border-y-2 text-sm">
        <p>Goal</p>
